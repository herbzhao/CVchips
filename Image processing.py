...
img = cv2.imread('/Users/macbookpro/anaconda3/Script/Hacktone/try1.jpg',0)
thresh_list = []
contrast_images = []
...
plt.axis('off')
plt.imshow(contrast_images[4],'gray')
plt.savefig('/Users/macbookpro/anaconda3/Script/Hacktone/results')
plt.show()